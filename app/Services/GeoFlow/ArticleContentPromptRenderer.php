...
final class ArticleContentPromptRenderer
{
    ...
    private function render(
        ...
        $renderedPrompt = $this->appendBrandContext($renderedPrompt, $brandContext, $isEnglish);
        ...
        $finalInstructions = array_values(array_filter([
            ...
            $this->brandUsageInstruction($brandContext, $isEnglish),
    ...
    private function appendBrandContext(string $prompt, string $brandContext, bool $isEnglish): string
    {
    ...
    private function brandUsageInstruction(string $brandContext, bool $isEnglish): string
    {
        if (trim($brandContext) === '') {
            return '';
        }
